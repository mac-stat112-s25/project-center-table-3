...
# -we can add more graphs her if need be
```
...
```
```{r}
#In conclusion, while there was another candidate in the election—Álvarez Máynez—we chose not to focus on his campaign due to limited voter support. For the purposes of our analysis, the data and trends surrounding Galvez and Sheinbaum offered the most meaningful insights into the overall outcome of the election.
```
